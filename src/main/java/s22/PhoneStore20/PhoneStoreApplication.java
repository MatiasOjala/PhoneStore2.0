...
import s22.PhoneStore20.domain.Application_User;
import s22.PhoneStore20.domain.ApplicationUserRepository;
import s22.PhoneStore20.domain.PhoneCondition;
import s22.PhoneStore20.domain.PhoneConditionRepository;
import s22.PhoneStore20.domain.Phone;
import s22.PhoneStore20.domain.PhoneRepository;
...
private static final Logger Log = LoggerFactory.getLogger(PhoneStoreApplication.class);
	...
	public CommandLineRunner phonestore(PhoneRepository phoneRepository) {
		return (args) -> {
			...
			auRepository.save(new Application_User("Matti", "Meikalainen", "USER", "user", 
					"$2a$10$qTuhvwviu0XCo5UWYECE5eHzFuXV6AfndNOPjF1JDIJOs7Mz7pDzG"));
			auRepository.save(new Application_User("Meikalainen", "Matti", "ADMIN", "admin", 
